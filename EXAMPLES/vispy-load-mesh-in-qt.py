...
import trimesh ## for loading custom meshes
import numpy as np
...
# mesh_file = os.path.join(os.path.dirname(__file__), 'Resources', 'Emotiv Epoc_SplitJoints_0001.fbx')
mesh_file = os.path.join(os.path.dirname(__file__), '../Resources', 'Full_scene_3.2_bundled.obj')

# mesh_file = load_data_file('orig/triceratops.obj.gz') ## example mesh
